...
const markupImg = createMarkupImg((0, _galleryItems.galleryItems));
conteinerGallary.insertAdjacentHTML("beforeend", markupImg);
function createMarkupImg(item) {
    return (0, _galleryItems.galleryItems).reduce((acc, { preview , original , description  })=>acc + `<a class="gallery__item" href="${original}">
